...
function saveComment(comment) {
    let comments = JSON.parse(localStorage.getItem('comments-area-kids')) || [];
    comments.push(comment);
    localStorage.setItem('comments-area-kids', JSON.stringify(comments));
...
function loadComments() {
    ...
    const comments = JSON.parse(localStorage.getItem('comments-area-kids')) || [];
